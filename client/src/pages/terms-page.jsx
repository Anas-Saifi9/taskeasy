      ...
      <section className="container mx-auto px-2 sm:px-4">
        <div className="w-full max-w-2xl mx-auto bg-gray-900 rounded-2xl shadow-xl border border-gray-800 p-4 sm:p-8 md:p-12">
          ...
          <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 text-center">
            By using TaskEasy, you agree to the following terms. Please read them carefully.
          </p>
          <div className="divide-y divide-gray-800">
            <div className="py-4 sm:py-6">
              <h2 className="font-bold text-white mb-2 text-base sm:text-lg">Use of Service</h2>
              <p className="text-gray-300 text-sm sm:text-base">TaskEasy is provided for personal and professional task management. You agree not to misuse the service or attempt to disrupt its operation.</p>
            </div>
            <div className="py-4 sm:py-6">
            ...
            <div className="py-4 sm:py-6">
              ...
              <p className="text-gray-300 text-sm sm:text-base">You retain ownership of your tasks and data. TaskEasy does not claim any rights over your content.</p>
            </div>
            <div className="py-4 sm:py-6">
              <h2 className="font-bold text-white mb-2 text-base sm:text-lg">Limitation of Liability</h2>
              <p className="text-gray-300 text-sm sm:text-base">TaskEasy is provided "as is" without warranties. We are not liable for any damages resulting from the use of the service.</p>
            </div>
            <div className="py-4 sm:py-6">
              <h2 className="font-bold text-white mb-2 text-base sm:text-lg">Changes to Terms</h2>
              <p className="text-gray-300 text-sm sm:text-base">We may update these terms from time to time. Continued use of TaskEasy means you accept any changes.</p>
            </div>
            <div className="py-4 sm:py-6">
              <h2 className="font-bold text-white mb-2 text-base sm:text-lg">Contact</h2>
              <p className="text-gray-300 text-sm sm:text-base">If you have any questions about these terms, contact us at <a href="mailto:anassaifi7303@gmail.com" className="text-blue-400 underline">anassaifi73031384@gmail.com</a>.</p>
            </div>
          </div>
