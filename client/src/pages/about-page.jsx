import { CheckSquare, Github, Mail, ExternalLink, Heart, Zap, Code, Database, Smartphone, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center mb-8">
            ...
            <span className="font-bold text-3xl ml-4">TaskEasy</span>
          </div>

          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            About <span className="text-blue-400">TaskEasy</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300">
              TaskEasy is crafted with passion and dedication by a skilled developer
            </p>
          </div>
          ...
          <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/50 p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <div className="w-32 h-32 rounded-full overflow-hidden flex items-center justify-center mx-auto md:mx-0 mb-6 border-4 border-blue-500/40 shadow-lg bg-gradient-to-br from-blue-600 to-blue-800">
                  <span className="text-4xl font-bold text-white">AS</span>
                </div>
                <h3 className="text-2xl font-bold mb-2">Anas Saifi</h3>
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  <a
                    href="https://github.com/Anas-Saifi9"
                    target="_blank"
                    rel="noreferrer"
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why <span className="text-blue-400">TaskEasy</span>?
            </h2>
            <p className="text-lg text-gray-300">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-blue-600/20 backdrop-blur-xl rounded-2xl border border-blue-700/30 p-8 md:p-12">
            ...
            <p className="text-gray-300 mb-6">
              Join thousands of users who have transformed their task management with TaskEasy
            </p>
            <Button
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white"
