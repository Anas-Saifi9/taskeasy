      ...
      <section className="container mx-auto px-2 sm:px-4">
        <div className="w-full max-w-2xl mx-auto bg-gray-900 rounded-2xl shadow-xl border border-gray-800 p-4 sm:p-8 md:p-12">
          ...
          <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 text-center">
            Your privacy is important to us. TaskEasy is committed to protecting your personal information and ensuring transparency in how your data is handled.
          </p>
          <div className="divide-y divide-gray-800">
            ...
            <div className="py-4 sm:py-6">
              ...
              <p className="text-gray-300 text-sm sm:text-base">If you have any questions about privacy, contact us at <a href="mailto:anassaifi7303@gmail.com" className="text-blue-400 underline">anassaifi7303@gmail.com</a>.</p>
            </div>
          </div>
